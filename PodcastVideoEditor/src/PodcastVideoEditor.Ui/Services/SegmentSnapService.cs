...
internal sealed class SegmentSnapService
{
    ...
    /// <summary>
    /// Unified segment timing update with operation detection, collision resolution,
    /// and grid snapping. Returns the final (start, end) or null if the operation is blocked.
    /// </summary>
