from pyJianYingDraft import trange, CapCut_Video_scene_effect_type, CapCut_Video_character_effect_type, exceptions
...
def add_effect_impl(
    ...
    # Select the corresponding effect type based on effect category
    effect_enum = None
